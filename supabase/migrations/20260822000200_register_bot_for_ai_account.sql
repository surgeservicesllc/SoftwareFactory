...
begin
  ...
  -- before the first CREATE OR REPLACE. A post-apply before/after comparison
  -- cannot prove that an already-drifted definition was the approved input.
  ...
  from (values
    ('public.register_bot(uuid,text,public.bot_provider,text,text,text,text)',
     '318700d6d8d26603d9f5572f11d16e2f'),
...
begin
  ...
  from (values
    ('public.ai_account_bot_credential_ref(public.bot_provider,text)',
     'd652a3406462bd5e9fcc4ae6afabdc49', 'i', 'none'),
    ('public.assign_bots_to_project_checked(uuid,uuid,jsonb)',
     '8d881acabd1e1f28ea74c3efc22354f3', 'v', 'authenticated'),
    ('public.enforce_bot_ai_account_binding()',
     '1acb03fac46c74be02b8e6ea746e0181', 'v', 'none'),
    ('public.ensure_ai_account_bot(uuid,uuid,public.bot_provider,text,text,boolean,text,text)',
     'eeb186b89ac3ba86f3c44bbc611d300e', 'v', 'authenticated'),
    ('public.increment_bot_assignment_revision()',
     'a38347e81d404d1e6e33782cbabcd16a', 'v', 'none'),
    ('public.increment_bot_revision()',
     '25974d86264401f18dc34d4f5e10be53', 'v', 'none'),
