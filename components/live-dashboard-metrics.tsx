  ...
  return (
    <section className="mb-6" aria-labelledby="live-metrics-title">
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard label="Open pull requests" value={state === "ready" && openPullRequests !== null ? String(openPullRequests) : "—"} detail={state === "ready" ? openPullRequests === null ? "Incomplete — one or more GitHub reads failed" : `Live across ${projects.length} connected project${projects.length === 1 ? "" : "s"}` : statusLabel} icon={GitPullRequestArrow} tone={openPullRequests === null ? "warning" : "info"} demo={false} />
