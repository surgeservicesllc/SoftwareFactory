...
- [x] Phase 1E control plane passes lint, typecheck, 140 files/1589 tests, a clean build, and Playwright 117/117 including axe, with the end-to-end journey and failed-rollback escalation proven against the migrated schema.
