...
- `vitest run`: 141 files / 1600 tests pass on the merged tree, including 30 Phase 1E behavioral tests, a 3-test end-to-end journey, 19 boundary contracts, 6 repair-promotion behaviors, 5 real-PostgreSQL concurrency tests, and 64 policy/probe/console/journey unit tests.
