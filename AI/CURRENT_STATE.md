...
- This is control-plane evidence against a migrated database. Hosted migrations `20260813000500` and `20260813000600` are **not applied**, and no automatic action has run or can run.
