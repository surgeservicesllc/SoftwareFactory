...
- Date: 2026-08-14
- Status: Accepted locally; migration `20260814000100` is unhosted
...
- Decision: `public.declare_model_characteristics(organization, provider, model, strength_tier, context_limit_tokens)` sets the two columns added by `20260814000200`, gated by `can_manage_organization`. Passing null clears a declaration. `GET`/`POST /api/resources/models` expose it.
...
- Date: 2026-08-15
- Status: Accepted locally; migrations `20260814001100` and `20260814001200` are unhosted
