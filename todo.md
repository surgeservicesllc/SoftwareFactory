...
Current `main`: `406d754` — all four PRs of 2026-08-14 merged with both required CI jobs green
...
Gates on current `main`: lint, typecheck, 140 files / 1589 tests, clean production build,
