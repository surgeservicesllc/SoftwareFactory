...
export default async function FeaturesPage() {
  ...
  return (
    <>
            ...
            <li key={stage.title}>
              <SurfacePanel className="flex h-full gap-4 p-5">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="font-mono text-[10px] text-[#7f8c9e]">
                ...
                <div className="min-w-0">
                  ...
                  <p className={`mt-3 text-[11px] font-medium ${resolveAccent(stage.accent).text}`}>
            ...
            {foundation.map((item) => (
              <li key={item.title} className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1.5 text-[11px] leading-5 text-[#7f8c9e]">{item.body}</p>
                </div>
              </li>
            ))}
          </ul>
      ...
      <MarketingSection className="mt-6">
        <p className="flex items-center gap-2 text-[11px] text-[#7f8c9e]">
