              ...
              <ul className="mt-6 grid grid-cols-2 gap-6 sm:grid-cols-5">
                {pillars.map((pillar) => (
                  <li key={pillar.title} className="text-center">
                    ...
                    <p className="mt-1 text-[10px] leading-4 text-[#7f8c9e]">{pillar.body}</p>
                  </li>
                ))}
              </ul>
            </SurfacePanel>
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,3fr)_minmax(0,1fr)]">
          ...
          <aside className="space-y-4">
                  ...
                  {security.map((item) => {
                    ...
                    return (
                      <li key={item.title} className="flex items-start gap-2.5">
                        ...
                        <span className="text-[11px] leading-5 text-[#c1cbd8]">{item.title}</span>
                      </li>
                    );
                  })}
                </ul>
            ...
            <SurfacePanel className="p-5">
              ...
              <p className="mt-2 text-[11px] leading-5 text-[#8593a5]">
              ...
              <p className="mt-4 flex items-center gap-2 text-[11px] text-[#8593a5]">
