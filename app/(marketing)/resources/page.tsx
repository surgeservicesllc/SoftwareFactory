                ...
                return (
                  <li key={pillar.title} className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-[11px] leading-5 text-[#7f8c9e]">{pillar.body}</p>
                    </div>
                  </li>
                );
              })}
              ...
              <li key={category.title}>
                <Link href="/resources" className="block h-full">
                  <SurfacePanel className="h-full p-4 transition-colors hover:border-[#33405a]">
                    ...
                    <p className="mt-2 text-[11px] leading-5 text-[#7f8c9e]">{category.body}</p>
                  </SurfacePanel>
                </Link>
              </li>
            ))}
        ...
        <div className="grid gap-4 lg:grid-cols-3">
                    ...
                    <li key={topic.name}>
                      <Link href={topic.href} className="group flex items-start gap-2.5">
                        ...
                        <span>
                          ...
                          <span className="mt-0.5 block text-[10px] text-[#7f8c9e]">
                  ...
                  return (
                    <li key={role.name}>
                      ...
                      >
                        ...
                        <span className="text-[10px] text-[#7f8c9e]">{role.resourceCount} resources</span>
          ...
          <SurfacePanel className="relative overflow-hidden border-[#3b2f6b] bg-gradient-to-br from-[#1b1440] to-[#0f1327] p-5 sm:p-6">
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-[11px] leading-5 text-[#b3a8d8]">
