...
const latestMigration =
  "20260830001300_billing_contracts.sql";
...
const publicTables = [
  ...
  "connections",
  // The Services CRM (ADR-185/186/189/190/191/193): twenty-two org-scoped
  // tables with service_role revoked outright — nothing server-side reads
  // the CRM.
  "crm_accounts",
  "crm_applications",
