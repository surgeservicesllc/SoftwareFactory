...
const latestMigration =
  "20260830001000_chemicals_compliance.sql";
...
const publicTables = [
  ...
  "connections",
  // The Services CRM (ADR-185/186/189/190/191): fifteen org-scoped tables
  // with service_role revoked outright — nothing server-side reads the CRM.
  "crm_accounts",
  "crm_applications",
