...
export const MARKETING_RESOURCES: readonly MarketingResource[] = [
  {
    ...
    level: "Beginner",
    href: "/resources/ultimate-guide-ai-powered-software-development",
    topic: "AI Agents",
    featured: true,
  },
  {
    ...
    readTime: null,
    level: "All Levels",
    href: "/resources/ai-agent-starter-kit",
    topic: "AI Agents",
    featured: true,
  },
  {
    ...
    readTime: "28 min",
    level: "Intermediate",
    href: "/resources/build-your-first-ai-agent",
    topic: "AI Agents",
    featured: true,
  },
  {
    ...
    readTime: "8 min read",
    level: "Case Study",
    href: "/resources/how-acme-scaled-5x-faster",
    topic: "Scaling",
    featured: true,
  },
  {
    ...
    readTime: null,
    level: "All Levels",
    href: "/resources/production-readiness-checklist",
  ...
  },
  {
    ...
    readTime: null,
    level: "All Levels",
    href: "/resources/platform-api-reference",
    topic: "DevOps & CI/CD",
    featured: false,
  },
  {
    ...
    readTime: "9 min read",
    level: "Intermediate",
    href: "/resources/automating-code-review",
    topic: "Best Practices",
    featured: false,
  },
  {
    ...
    readTime: null,
    level: "Advanced",
    href: "/resources/zero-downtime-deployment-playbook",
    topic: "DevOps & CI/CD",
    featured: false,
  },
];
