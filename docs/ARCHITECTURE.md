...
| Vercel | Serve Next.js application and server functions | Exact project `surgeservices-projects/softwarefactory` is linked and encrypted environment names are present; last independently verified pre-hardening release: `f12814bd94001e5c9fe9637e0350e14816de8d13` on `dpl_9M66dxkkNiqTTRVbC2SGqzXzkwju`, public E2E 12/12; deploy/rollback adapter **Not Connected** |
